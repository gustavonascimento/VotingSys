<template>
  <div class="posts">
    ...
    <button v-on:click="getCurrentStandingAdmin()">Obter Resultado</button>
...
export default {
  ...
  methods: {
    async getCurrentStandingAdmin() {
      //this.response = null;
      
      this.runSpinner();

      // console.log(`this.selected ${this.selected}`);
      const apiResponse = await PostsService.getCurrentStandingAdmin();
